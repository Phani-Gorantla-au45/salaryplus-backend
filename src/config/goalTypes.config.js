...
export const GOAL_TYPES = [
  {
    ...
    fields: [
      ...
      { key: "pre_retirement_return",     label: "Before Retirement Return",         type: "number", unit: "%",      required: false, default: 12 },
      { key: "post_retirement_return",    label: "After Retirement Return",          type: "number", unit: "%",      required: false, default: 7  },
